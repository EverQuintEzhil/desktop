...
const AgentAPIPlayground = (props: Props) => {
    ...
    return (
        <div className="tab-content agent-api-playground px-6 pt-4">
            <div className="agent-api agent-api-playground-styled flex h-[calc(100svh-182px)] overflow-hidden bg-card max-lg:h-auto max-lg:flex-initial max-lg:flex-col max-lg:overflow-auto">
                ...
                <div className="right-panel flex flex-1 flex-col overflow-hidden bg-card max-lg:flex-initial max-lg:overflow-auto">
                    <div className="playground-response-section response-section flex flex-1 flex-col overflow-hidden max-lg:flex-initial max-lg:overflow-auto">
