                            ...
                            validators={{
                                onChange: ({ value }) => {
                                    const hasValue =
                                        typeof value === 'string'
                                            ? value.length > 0
                                            : isSelectSuggestionItem(value) && value.value.length > 0;

                                    if (dynamicField?.required && !hasValue) {
                                        return `${dynamicField.label} is required`;
                                    }
